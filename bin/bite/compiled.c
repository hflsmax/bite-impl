...
&locals.fset;});
((int(*)(void*, int, closure_t*, closure_t*))locals.env->counter->f_ptr)(locals.env->counter, locals.n, locals.lget, locals.lset);});}
...
locals.g.env = &locals;
&locals.g;});
((int(*)(void*, int))locals.run->f_ptr)(locals.run, 10);});}
