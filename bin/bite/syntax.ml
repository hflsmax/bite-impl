...
type lambda_kind = TailResumptive | Abortive | GeneralHandler | Lambda
[@@deriving sexp]
...
module R = struct
  (* Rich hvar *)
  type hvar = string * fname * ty [@@deriving sexp]
  ...
  and expr' =
    | Var of int * name
      (* int indicates the depth of var within the static link. It is not used in the source language *)
    | Int of int
    | Bool of bool
    | Times of expr * expr
    | Plus of expr * expr
